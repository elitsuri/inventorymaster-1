...
app = FastAPI(
    title="inventorymaster-1",
    description="InventoryMaster 1: Warehouse management with barcode scanning and forecasting",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "inventorymaster-1"}
